    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新建设备配件</h4>
            </div>
            <div class="modal-body">
                <form id="consumablesForm">
                    <div class="form-group">
                        <label for="description">设备配件名称</label>
...
<div class="modal fade" id="draw_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">领取设备配件</h4>
            </div>
            <div class="modal-body">
                <form id="drawForm">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box border blue">
                        <div class="box-title">
                            <h4><i class="fa fa-table"></i>设备配件信息</h4>
                        </div>
                        <div class="box-body">
