...
<table id="equipmentsDataTable" class=" table table-striped table-bordered table-hover" data-toggle="bootgrid"
       data-ajax="true" data-url="/equipment/data">
    <thead>
    <tr>
        ...
        <th data-column-id="manager" data-width="10%">设备归属单位</th>
