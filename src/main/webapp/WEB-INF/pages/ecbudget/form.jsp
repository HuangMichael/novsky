...
<form class="form-horizontal myform" role="form" id="detailForm">
	...
	<fieldset class="form-group" id="a">
		...
		<div class="form-group">
			...
			<div class="col-md-3">
				<input class="form-control" id="applyDate" type="text" name="applyDate" v-model="budgetBill.applyDate" value="1" />
			</div>
	...
	<fieldset class="form-group" id="a">
		<div class="form-group">
			...
			<div class="col-md-3">
				<input class="form-control" id="ecName" type="text" name="ecName" v-model="budgetBill.ecName" />
			</div>
	...
	<fieldset class="form-group" id="a">
		<div class="form-group">
			...
			<div class="col-md-8">
				<select class="js-example-basic-multiple" multiple="multiple" style="width:90% " name="updateReason" id="updateReason">
	...
	<fieldset class="form-group" id="a">
		...
		<div class="form-group">
			...
			<div class="col-md-2">
				<input class="form-control" id="auditDate" type="number" name="amount" v-model="budgetBill.amount" value="1" />
			</div>
