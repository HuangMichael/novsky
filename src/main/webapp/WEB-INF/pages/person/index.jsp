        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">鏂板缓浜у搧淇℃伅</h4>
                </div>
                <div class="modal-body">
                    <form id="productCreateForm">
                        <div class="form-group">
                            <label for="productName">浜у搧鍚嶇О</label>
                        ...
                        <div class="form-group">
                            <label for="productDesc">鏄惁涓婄嚎</label>
                        ...
                        <div class="form-group">
                            <label for="productDesc">涓婄嚎鏃ユ湡</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal">鍏抽棴
                    </button>
                    <button type="button" id="create" name="createBtn"
                            class="btn btn-primary">淇濆瓨
                    </button>
                </div>
            </div>
        </div>
