...
!function (a, b, c) {
    ...
    function D(a) {
        ...
        if (this.options.multiSort || (a.parents("tr").first().find(c).removeClass(b.iconDown + " " + b.iconUp), this.sortDictionary = {}), e && "asc" === e) {
            ...
            if (e && "desc" === e) {
                if (this.options.multiSort) {
                    ...
                    this.sortDictionary[d] = "asc", f.removeClass(b.iconDown).addClass(b.iconUp)
                }
            } else {
                this.sortDictionary[d] = "asc", f.addClass(b.iconUp)
            }
        }
    }
    ...
    function G() {
        ...
        if (!this.options.ajax) {
            for (var c in this.sortDictionary) {
                (this.options.multiSort || 0 === b.length) && b.push({id: c, order: this.sortDictionary[c]})
            }
    ...
    if (I.defaults = {
            ...
            templates: {
                ...
                body: "<tbody></tbody>",
                cell: '<td style="min-width: 5%;max-width:30%">{{ctx.content}}</td>',
                footer: '<div id="{{ctx.id}}" class="{{css.footer}}"><div class="row"><div class="col-sm-6"><p class="{{css.pagination}}"></p></div><div class="col-sm-6 infoBar"><p class="{{css.infos}}"></p></div></div></div>',
                header: '<div id="{{ctx.id}}" class="{{css.header}}"><div class="row"><div class="col-sm-12 actionBar"><p class="{{css.search}}"></p><p class="{{css.actions}}"></p></div></div></div>',
                headerCell: '<th data-column-id="{{ctx.column.id}}" class="{{ctx.css}}" style="{{ctx.style}},width:auto"><a href="javascript:void(0);" class="{{css.columnHeaderAnchor}} {{ctx.sortable}}"><span class="{{css.columnHeaderText}}">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>',
        ...
        }, I.prototype.reload = function (current) {
            ...
            if (a = a || "", this.searchPhrase !== a) {
                ...
                console.log("搜索关键字----------" + searchPhrase);
            ...
            if (this.selection) {
                ...
                if (e.length > 0) {
                    ...
                    for (d = 0; !this.options.keepSelection && g && d < this.currentRows.length;) {
                        g = -1 !== a.inArray(this.currentRows[d++][this.identifier], this.selectedRows)
                    }
                    for (this.element.find("thead " + f).prop("checked", g), this.options.multiSelect || this.element.find("tbody > tr " + f + ":checked").trigger("click" + H), d = 0; d < this.selectedRows.length; d++) {
                        this.element.find('tbody > tr[data-row-id="' + this.selectedRows[d] + '"]').addClass(this.options.css.selected)._bgAria("selected", "true").find(f).prop("checked", !0)
                    }
            ...
            if (this.selection) {
                ...
                if (f.length > 0) {
                    ...
                    for (this.element.find("thead " + g).prop("checked", !1), d = 0; d < f.length; d++) {
                        this.element.find('tbody > tr[data-row-id="' + f[d][this.identifier] + '"]').removeClass(this.options.css.selected)._bgAria("selected", "false").find(g).prop("checked", !1)
                    }
            ...
            console.log("searchPhrase is here");

            return "1231,con,323412"
    ...
    a.fn.bootgrid = function (b) {
        var c = Array.prototype.slice.call(arguments, 1), d = null, e = this.each(function (e) {
            ...
            if ((g || "destroy" !== b) && (g || (f.data(H, g = new I(this, h)), j.call(g)), "string" == typeof b)) {
                if (0 === b.indexOf("get") && 0 === e) {
                    d = g[b].apply(g, c)

                    console.log("this is d-----------"+d)
                } else {
                    if (0 !== b.indexOf("get")) {
                        return g[b].apply(g, c)
                    }
                }
            }
        });
